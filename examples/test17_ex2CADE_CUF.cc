...
int main(int argc, char** argv)
{
    ...
    PTRef const1 = logic.mkCUFConst(2);

    PTRef eq_two = logic.mkEq(k, const1);

    PTRef c1 = logic.mkCUFNumVar("c1");
    PTRef c2 = logic.mkCUFNumVar("c2");

    PTRef mod1 = logic.mkCUFMod(a, const1);
    PTRef mod2 = logic.mkCUFMod(b, const1);
    PTRef plus1 = logic.mkCUFPlus(mod1, mod2);
    PTRef mod3 = logic.mkCUFMod(plus1, const1);
    PTRef eq1= logic.mkEq(mod3, c1);

    PTRef plus2 = logic.mkCUFPlus(a, b);
    PTRef mod4 = logic.mkCUFMod(plus2, const1);
