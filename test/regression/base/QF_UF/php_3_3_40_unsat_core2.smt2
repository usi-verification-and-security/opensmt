...
(assert (! (or (or (and (or (not x_39_0) (not x_39_1) (not x_39_2)) (or x_39_0 (not x_39_1) (not x_39_2)) (or (not x_39_0) x_39_1 (not x_39_2)) (or x_39_0 x_39_1 (not x_39_2)) (or (not x_39_0) (not x_39_1) x_39_2) (or x_39_0 (not x_39_1) x_39_2) (or (not x_39_0) x_39_1 x_39_2) (or x_39_0 x_39_1 x_39_2))) (distinct a_39_0 a_39_1 a_39_2 a_39_3 a_39_4 a_39_5 a_39_6 a_39_7 a_39_8 a_39_9 a_39_10 a_39_11 a_39_12 a_39_13 a_39_14 a_39_15 a_39_16 a_39_17 a_39_18 a_39_19 a_39_20 a_39_21 a_39_22 a_39_23 a_39_24 a_39_25 a_39_26 a_39_27 a_39_28 a_39_29 a_39_30 a_39_31 a_39_32 a_39_33 a_39_34 a_39_35 a_39_36 a_39_37 a_39_38 a_39_39)) :named a40))
(assert (! (= a_0_0 a_1_0) :named a41))
(assert (! (= a_1_0 a_2_0) :named a42))
(assert (! (= a_2_0 a_3_0) :named a43))
(assert (! (= a_3_0 a_4_0) :named a44))
(assert (! (= a_4_0 a_5_0) :named a45))
(assert (! (= a_5_0 a_6_0) :named a46))
(assert (! (= a_6_0 a_7_0) :named a47))
(assert (! (= a_7_0 a_8_0) :named a48))
(assert (! (= a_8_0 a_9_0) :named a49))
(assert (! (= a_9_0 a_10_0) :named a50))
(assert (! (= a_10_0 a_11_0) :named a51))
(assert (! (= a_11_0 a_12_0) :named a52))
(assert (! (= a_12_0 a_13_0) :named a53))
(assert (! (= a_13_0 a_14_0) :named a54))
(assert (! (= a_14_0 a_15_0) :named a55))
(assert (! (= a_15_0 a_16_0) :named a56))
(assert (! (= a_16_0 a_17_0) :named a57))
(assert (! (= a_17_0 a_18_0) :named a58))
(assert (! (= a_18_0 a_19_0) :named a59))
(assert (! (= a_19_0 a_20_0) :named a60))
(assert (! (= a_20_0 a_21_0) :named a61))
(assert (! (= a_21_0 a_22_0) :named a62))
(assert (! (= a_22_0 a_23_0) :named a63))
(assert (! (= a_23_0 a_24_0) :named a64))
(assert (! (= a_24_0 a_25_0) :named a65))
(assert (! (= a_25_0 a_26_0) :named a66))
(assert (! (= a_26_0 a_27_0) :named a67))
(assert (! (= a_27_0 a_28_0) :named a68))
(assert (! (= a_28_0 a_29_0) :named a69))
(assert (! (= a_29_0 a_30_0) :named a70))
(assert (! (= a_30_0 a_31_0) :named a71))
(assert (! (= a_31_0 a_32_0) :named a72))
(assert (! (= a_32_0 a_33_0) :named a73))
(assert (! (= a_33_0 a_34_0) :named a74))
(assert (! (= a_34_0 a_35_0) :named a75))
(assert (! (= a_35_0 a_36_0) :named a76))
(assert (! (= a_36_0 a_37_0) :named a77))
(assert (! (= a_37_0 a_38_0) :named a78))
(assert (! (= a_38_0 a_39_0) :named a79))
(assert (! (= a_39_0 a_0_1) :named a80))
(check-sat)
(get-unsat-core)
