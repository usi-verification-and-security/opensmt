...
public:
  ...
  std::string get_vertex_label(const unsigned int vertex) const;
   ...
   */
  unsigned int add_vertex(const unsigned int color = 0, const std::string label = std::string{""});
...
public:
  ...
  std::string get_vertex_label(unsigned int vertex) const;

  const T* get_vertex_value(unsigned int vertex) const;
   ...
   */
  unsigned int add_vertex(const unsigned int color = 0, const std::string label = std::string{""}, const T* value = NULL);
