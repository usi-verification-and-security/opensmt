...
ProofGraph::verifyPartialInterpolantA(ProofNode *n, const ipartitions_t& mask)
{
    ...
    */
    ...
    bool res = VerificationUtils(config, logic, pmanager).implies(implicant, n->getPartialInterpolant());
    assert(res);
    return res;
}
...
ProofGraph::verifyPartialInterpolantB(ProofNode *n, const ipartitions_t& mask)
{
    ...
    */
    ...
    bool res = VerificationUtils(config, logic, pmanager).implies(implicant, logic.mkNot(n->getPartialInterpolant()));
    assert(res);
    return res;
}
