...
//    EnodeStore estore;
    ...
    // not real reasons...
    ELRef dist_b = egraph.forbid_allocator.alloc(er_b, eq_ptr);
    ELRef dist_c = egraph.forbid_allocator.alloc(er_c, eq_ptr);
    ELRef dist_f = egraph.forbid_allocator.alloc(er_f, eq_ptr);
