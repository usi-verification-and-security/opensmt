...
public:
    ...
    Map<PTRef,PtAsgn,PTRefHash> operator() (vec<Map<PTRef,PtAsgn,PTRefHash>::Pair*>&& substs);
    ...
    Map<PTRef,PtAsgn,PTRefHash> constructLooplessSubstitution(vec<Map<PTRef,PtAsgn,PTRefHash>::Pair*>&& substs);
};
